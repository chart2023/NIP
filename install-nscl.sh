...
wget --tries=10 -O - http://192.168.9.11:8080/v1/AUTH_e619f03c8bbb4873998c5c040a98f104/openmtc/node-v0.10.42.tar.gz | tar -xz
cd /node-v0.10.42/
./configure && make && sudo make install
cd ..
sudo apt-get install -y build-essential
sudo npm -g install npm@2.7.6
wget --tries=10 http://192.168.9.11:8080/v1/AUTH_e619f03c8bbb4873998c5c040a98f104/openmtc/OpenMTC-nscl.zip -O /home/ubuntu/OpenMTC-nscl.zip
